...
export class InvocationCounter {
    ...
    increment() {
        if (this.#value >= this.#max) {
            throw new KeyExhaustedError(`key has reached the maximum of ${String(this.#max)} invocations; generate a new key`);
        }
        this.#value += 1;
    }
    /** Test-only: fast-forward the counter without performing real encryptions. */
    _setValueForTesting(value) {
...
//# sourceMappingURL=invocation-counter.js.map